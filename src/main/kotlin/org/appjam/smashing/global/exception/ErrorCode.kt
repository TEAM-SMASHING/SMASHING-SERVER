...
enum class ErrorCode(
    ...
    // Auth - Refresh Token
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-011", "유효하지 않은 리프레시 토큰입니다."),
    EXPIRED_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-012", "만료된 리프레시 토큰입니다."),
    REFRESH_TOKEN_MISMATCH(HttpStatus.UNAUTHORIZED, "AUTH-013", "저장된 리프레시 토큰과 일치하지 않습니다."),
    ...
    INVALID_REFRESH_TOKEN_TYPE(HttpStatus.UNAUTHORIZED, "AUTH-017", "리프레시 토큰의 타입이 올바르지 않습니다."),
